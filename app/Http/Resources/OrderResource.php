...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'ordered_from_type' => $this->orderable_from_type == Warehouse::class ? 'Warehouse' : 'DistributionCenter',
            ...
            'ordered_by_type' => $this->orderable_by_type == Warehouse::class ? 'Warehouse' : 'DistributionCenter',
            ...
            'shipping_cost' => $this->shipment ? (float)$this->shipment->cost : round((float)($this->total_cost - $this->order_cost), 2),
